...
String branch_name = request.getParameter("EditBranch");
//out.write(branch_id);
    //l.getBranch(branch_id);
%>
								...
								<div class="span12">
									<div class="grid simple">
										...
										<div class="grid-body no-border">
                                                                                    <form id="EditBranch" name="EditBranch" method="post" action="../BranchEdit">
												
												<div class="row-fluid column-seperation">
													<div class="span6">
														<div class="row-fluid">
															<div class="span12">
																 <input name="EditBranch" 
                                                                                                                                        id="EditBranch" type="text" class="span12"
                                                                                                                                        placeholder="Enter Branch" value="<%out.write( l.getBranch(branch_id));%>">
                                                                                                             <input type="hidden" value="<%out.write(branch_id);%>" name="id" />
															</div>
														</div>
													</div>
												</div>
												<div class="form-actions">
													<div class="pull-left">
                                                                                                            <button class="btn btn-danger btn-cons" type="submit" name="Branch_add_button">
