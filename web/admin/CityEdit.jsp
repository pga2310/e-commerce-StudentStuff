...
String city_name = request.getParameter("EditCity");
//out.write(branch_id);
								...
								<div class="span12">
									<div class="grid simple">
										...
										<div class="grid-body no-border">
                                                                                    <form id="EditCity" name="EditCity" method="post" action="../CityEdit">
												...
												<div class="row-fluid column-seperation">
													<div class="span6">
														<div class="row-fluid">
															<div class="span12">
																 <input name="EditCity" 
                                                                                                                                        id="EditCity" type="text" class="span12"
                                                                                                                                        placeholder="Enter Branch" value="<%out.write(l.getCity(city_id));%>">
                                                                                                             <input type="hidden" value="<%out.write(city_id);%>" name="id" />
															</div>
														</div>
													</div>
												</div>
												<div class="form-actions">
													<div class="pull-left">
                                                                                                            <button class="btn btn-danger btn-cons" type="submit" name="City_add_button">
