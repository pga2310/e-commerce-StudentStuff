								...
								<div class="span12">
									<div class="grid simple">
										...
										<div class="grid-body no-border">
                                                                                    <form id="EditBranch" name="AddBranch" method="post" action="../BranchAdd">
												
												<div class="row-fluid column-seperation">
													<div class="span6">
														<div class="row-fluid">
															<div class="span12">
																 <input name="AddBranch" 
                                                                                                                                        id="AddBranch" type="text" class="span12"
												...
												<div class="form-actions">
													<div class="pull-left">
                                                                                                            <button class="btn btn-danger btn-cons" type="submit" name="AddBranch_Button">
